...
//    View Classrooms:
//    Students can view a list of the classrooms they are enrolled in.
//    API Endpoint: GET /students/{studentId}/classrooms
//    Response: [{ "classroomId": "string", "classroomName": "string" }]

    @PreAuthorize("hasRole('ROLE_STUDENT')")
    @GetMapping("/{studentId}/classrooms")
    public ResponseEntity<?> viewClassrooms(String studentId){
