...
public class ClassroomController {
    ...
    public ResponseEntity<?> addStudentToClassroom(@PathVariable String classroomId, @RequestBody AddRemoveStudent student){
        if (this.classroomService.addStudentToClassroom(classroomId, student.getStudentName())){
    ...
    public ResponseEntity<?> removeStudentFromClassroom(@PathVariable String classroomId, @RequestBody AddRemoveStudent student){
    ...
    public ResponseEntity<?> editClassroom(@PathVariable String classroomId){
    ...
    public ResponseEntity<?> assignTaskToClassroom(@PathVariable String classroomId, @RequestBody TaskDto task){
